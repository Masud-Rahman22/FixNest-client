    ...
    return (
        <div className="px-4 py-8 shadow-lg max-w-[350px] font-sans rounded-xl space-y-6 my-20 mx-auto bg-white">
            <div className="flex justify-center w-full h-48 lg:h-[280px] relative">
                ...
                <img className="rounded-lg bg-black/40 w-full h-full" src={picture} alt="img" />
            </div>
            <div className="text-center w-[85%] mx-auto font-semibold space-y-2">
                <h6 className="text-sm md:text-base lg:text-lg">{name}</h6>
                <p className="text-gray-400 text-xs md:text-sm font-semibold">{type}</p>
                <p className="text-gray-400 text-xs md:text-sm font-semibold">{description}</p>
            </div>
