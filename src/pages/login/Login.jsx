...
const Login = () => {
    ...
    return (
        <div className="flex items-center justify-between">
            ...
            <div className="relative flex flex-col text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border flex-1 lg:pl-32" data-aos="fade-down" data-aos-duration="1000"
