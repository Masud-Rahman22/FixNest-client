...
const OurWork = () => {
    return (
        <div>
            <h1 className="font-inter font-extrabold text-4xl text-center mt-3">The<span className="text-blue-400">-</span>Repair<span className="text-blue-400">-</span>Pulse</h1>
