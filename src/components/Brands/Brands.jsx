...
export const CarouselMain = () => {
    ...
    return (
        <div className="sm:w-2/3 h-[540px] md:h-[670px] flex items-center relative overflow-hidden">
            ...
            {/* slider container */}
            <div className="ease-linear duration-300 flex gap-[2%]" data-aos="fade-right" data-aos-duration="3000"
                    data-aos-easing="ease-in-out" style={{ transform: `translateX(-${currentSlider * 52}%)` }}>
                {/* sliders */}
...
export const Brands = () => {
    return (
        <div className="max-w-7xl mx-auto h-[540px] lg:h-[670px] px-3 lg:px-10 flex flex-col lg:flex-row items-center justify-center overflow-hidden gap-5 lg:gap-10 relative mb-10" data-aos="fade-left" data-aos-duration="3000"
